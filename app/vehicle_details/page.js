            ...
            <div className="container mx-auto px-24 py-8">
               ...
               {/* Images */}
                ...
                <div>
                    ...
                    <div className="flex items-center gap-2">
                    <svg width="24" height="24" viewBox="0 0 21 35" fill="none" className="w-10 h-10  rounded-full bg-gray-200" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex items-center gap-2">
                    <svg width="24" height="24" viewBox="0 0 25 33" fill="none" className="w-10 h-10  rounded-full bg-gray-200" xmlns="http://www.w3.org/2000/svg">

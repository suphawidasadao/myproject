            ...
            <div className="container mx-auto px-24 py-8">
               ...
               {/* Images */}
                ...
                <div>
                    ...
                    <svg width="26" height="26" viewBox="0 0 24 24" fill="none"  className="w-10 h-10 rounded-full bg-gray-200 p-2"xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex items-center gap-2">
                    <svg width="26" height="26" viewBox="0 0 20 24" fill="none" className="w-10 h-10 rounded-full bg-gray-200 p-2" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex items-center gap-2">
                    <svg width="24" height="24" viewBox="0 -4 21 35" fill="none" className="w-10 h-10  rounded-full bg-gray-200" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex items-center gap-2">
                    <svg width="24" height="24" viewBox="0 -5 25 40" fill="none" className="w-10 h-10 rounded-full bg-gray-200" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex items-center gap-2">
                    <svg width="24" height="24" viewBox="0 -4 25 33" fill="none" className="w-10 h-10  rounded-full bg-gray-200" xmlns="http://www.w3.org/2000/svg">

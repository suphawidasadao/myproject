        ...
        <div className="relative">
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div>
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-200" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex items-center gap-2">
                    <svg width="21" height="24" viewBox="0 0 21 24" fill="none" className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-200" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M2.18786 23H18.8121C19.4676 23 20 22.4526 20 21.778V2.22203C20 1.54736 19.4682 1 18.8121 1H2.18786C1.87292 1 1.57087 1.12873 1.34812 1.35789C1.12537 1.58705 1.00015 1.89787 1 2.22203V21.778C1 22.4526 1.5318 23 2.18786 23Z" stroke="#D9D9D9" strokeLinecap="round" strokeLinejoin="round"/>
                        ...
                        <span className="material-icons">hvac</span>
                        เกียร์ออโต้
                    </div>
                    <div className="flex items-center gap-2">
                    <svg width="24" height="24" viewBox="0 0 21 24" fill="none" className="w-20 h-7 flex items-center justify-center rounded-full bg-gray-200" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Reviews Section */}
                <div className="mt-8">
                    <h2 className="text-xl font-semibold mb-4">รีวิวร้านเช่า</h2>
                    <div>
                        ...
                        {/*คะแนนรีวิว*/}
                        <div className="bg-white p-6 rounded-2xl shadow-md w-auto max-w-md mx-auto"/>
                ...
                <section className="mb-8">
                    ...
                    <p className="mb-2">
                        <strong>จุดรับรถ:</strong> พื้นที่รับส่ง
                                                ...
                                                ซีคอนสแควร์ บางแค: ค่าส่งรถ 300 บาท, ค่ารับรถ 350 บาท<br/>
                                                BTS อโศก: ค่าส่ง-รับรถ 350 บาท (ต่อเที่ยว)<br/>
                                                BTS บางนา: ค่าส่งรถ 500 บาท, ค่ารับรถ 400 บาท<br/>
                                                BTS ตลาดพลู: ค่าส่งรถ 300 บาท, ค่ารับรถ 400 บาท<br/>
                                                สถานีกลางกรุงเทพอภิวัฒน์: ค่าส่งรถ 100 บาท, ค่ารับรถฟรี<br/>
                                                สนามบินสุวรรณภูมิ: ค่าส่ง-รับรถ 400 บาท (ต่อเที่ยว)<br/>
                                                ถนนพระราม 9 RCA (ตึกรอยัลซิตี้อเวนิว): ค่าส่งรถ 200 บาท, ค่ารับรถ 100 บาท<br/>
                                                BTS อารีย์: ค่าส่ง-รับรถ 200 บาท (ต่อเที่ยว)<br/>
                                                BTS สะพานตากสิน: ค่าส่ง-รับรถ 300 บาท (ต่อเที่ยว)<br/>
                                                BTS อนุสาวรีย์ชัยสมรภูมิ: ค่าส่ง-รับรถ 200 บาท (ต่อเที่ยว)<br/>
                                                สถานีขนส่งสายใต้: ค่าส่ง-รับรถ 500 บาท (ต่อเที่ยว)<br/>
                                                โลตัส บางนา: ค่าส่ง-รับรถ 500 บาท (ต่อเที่ยว)<br/>
                                                บิ๊กซี วงศ์สว่าง: ค่าส่ง-รับรถฟรี<br/>
                                                มิลเลนเนียม ออโต้ ลาดพร้าว: ค่าส่งรถ 200 บาท, ค่ารับรถ 250 บาท<br/>
                                                ถนนสาทรเหนือ (อาคารโครนอส สาทร): ค่าส่ง-รับรถ 300 บาท (ต่อเที่ยว)<br/>
                                                ไอทีสแควร์: ค่าส่ง-รับรถ 200 บาท (ต่อเที่ยว)<br/>
                                                BTS พร้อมพงษ์: ค่าส่งรถ 500 บาท, ค่ารับรถฟรี<br/>
                                                เดอะมอลล์ บางกะปิ: ค่าส่ง-รับรถ 200 บาท (ต่อเที่ยว)<br/>
                                                BTS อุดมสุข: ค่าส่งรถ 400 บาท, ค่ารับรถ 300 บาท<br/>
                                                MRT บางใหญ่: ค่าส่ง-รับรถฟรีBTS <br/>
                                                บางหว้า: ค่าส่งรถ 300 บาท, ค่ารับรถ 400 บาท<br/>
                                                เซ็นทรัล รามอินทรา: ค่าส่ง-รับรถ 200 บาท (ต่อเที่ยว)<br/>
                                                BTS ช่องนนทรี: ค่าส่ง-รับรถ 300 บาท (ต่อเที่ยว)<br/>
                                                สถานีรถไฟดอนเมือง: ค่าส่ง-รับรถ 100 บาท (ต่อเที่ยว)<br/>
                                                มหาวิทยาลัยหอการค้าไทย: ค่าส่งรถ 300 บาท, ค่ารับรถ 200 บาท<br/>
                                                แยกพระราม4 รัชดาภิเษก: ค่าส่ง-รับรถ 300 บาท (ต่อเที่ยว)<br/>
                                                เซ็นทรัล พระราม 9: ค่าส่ง-รับรถ 200 บาท (ต่อเที่ยว)<br/>
                                                แอร์พอร์ตลิงก์ ลาดกระบัง: ค่าส่ง-รับรถ 400 บาท (ต่อเที่ยว)<br/>
                                                เมเจอร์รัชโยธิน: ค่าส่ง-รับรถ 200 บาท (ต่อเที่ยว)<br/>
                                                BTS สยาม: ค่าส่ง-รับรถ 300 บาท (ต่อเที่ยว)<br/>
                                                เซ็นทรัล พระราม 2: ค่าส่งรถ 350 บาท, ค่ารับรถ 300 บาท<br/>
                                                The Circle ราชพฤกษ์: ค่าส่ง-รับรถ 200 บาท (ต่อเที่ยว)<br/>
                                                แยกรัชดา-ลาดพร้าว: ค่าส่ง-รับรถ 200 บาท (ต่อเที่ยว)<br/>
                                                แฟชั่นไอส์แลนด์: ค่าส่ง-รับรถ 500 บาท (ต่อเที่ยว)<br/>
                                                เซ็นทรัล อีสต์วิลล์: ค่าส่ง-รับรถ 200 บาท (ต่อเที่ยว)<br/>
                                                BTS แบริ่ง: ค่าส่ง-รับรถ 350 บาท (ต่อเที่ยว)<br/>
                                                เซ็นทรัล เวสต์เกต: ค่าส่งรถ 100 บาท, ค่ารับรถฟรี<br/>
                                                แอร์พอร์ตลิงก์ รามคำแหง: ค่าส่งรถ 400 บาท, ค่ารับรถ 200 บาท<br/>

...
import Link from 'next/link';
    ...
    export default function Home() {
        const images = [
            "https://search.drivehub.com/_next/image?url=https%3A%2F%2Fdrivehubv3.s3-ap-southeast-1.amazonaws.com%2Fcars%2Fa03377b0-5d57-44c4-b3c4-cf92ca5d3a96%2Fphotos%2F1b2720c8-39ac-434c-9917-4fd450ebc664%2Flarge.png&w=3840&q=100",
            "https://search.drivehub.com/_next/image?url=https%3A%2F%2Fdrivehubv3.s3-ap-southeast-1.amazonaws.com%2Fcars%2Fa03377b0-5d57-44c4-b3c4-cf92ca5d3a96%2Fphotos%2F7c3de337-9297-42a1-a350-977a1a9d20a2%2Flarge.png&w=3840&q=100",
            "https://search.drivehub.com/_next/image?url=https%3A%2F%2Fdrivehubv3.s3-ap-southeast-1.amazonaws.com%2Fcars%2Fa03377b0-5d57-44c4-b3c4-cf92ca5d3a96%2Fphotos%2F2ba7ee84-0494-4249-bf4e-94befaa17854%2Flarge.png&w=3840&q=100",
            "https://search.drivehub.com/_next/image?url=https%3A%2F%2Fdrivehubv3.s3-ap-southeast-1.amazonaws.com%2Fcars%2Fa03377b0-5d57-44c4-b3c4-cf92ca5d3a96%2Fphotos%2F896856af-855c-49b7-bf9e-e75e260df9e3%2Flarge.png&w=3840&q=100",
            "https://search.drivehub.com/_next/image?url=https%3A%2F%2Fdrivehubv3.s3-ap-southeast-1.amazonaws.com%2Fcars%2Fa03377b0-5d57-44c4-b3c4-cf92ca5d3a96%2Fphotos%2F2f31754d-624d-4541-9374-b0ade7738789%2Flarge.png&w=3840&q=100",
        ];
            ...
            <div className="container mx-auto px-24 py-8">
               ...
               <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
                ...
                <div>
                    ...
                    <svg width="26" height="26" viewBox="0 0 24 24" fill="none"  className="w-8 h-8 rounded-full bg-gray-200 p-2"xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        <span className="material-icons text-xs text-gray-400">ประเภทรถ</span>
                        <p className='text-sm'>รถเก๋ง 4 ประตู</p>
                    </div>
                    </div>
                    <div className="flex items-center gap-2">
                    <svg width="26" height="26" viewBox="0 0 20 24" fill="none" className="w-8 h-8 rounded-full bg-gray-200 p-2" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        <span className="material-icons text-xs text-gray-400">ระบบเกียร์ <br/>
                        <p className='text-sm text-gray-600'>เกียร์ออโต้</p>
                        </span>
                        </div>
                    </div>
                    <div className="flex items-center gap-2">
                    <svg width="24" height="24" viewBox="0 -4 21 35" fill="none" className="w-8 h-8  rounded-full bg-gray-200" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M19 14H16V16H19V14ZM22 21H3V11L11 3H21C21.2652 3 21.5196 3.10536 21.7071 3.29289C21.8946 3.48043 22 3.73478 22 4V21ZM11.83 5L5.83 11H20V5H11.83Z" fill="#7D7D7D"/>
                        ...
                        <span className="material-icons text-xs text-gray-400">จำนวนประตู <br/>
                        <p className='text-sm text-gray-600'>4 ประตู</p>
                        </span>
                    </div>
                    <div className="flex items-center gap-2">
                    <svg width="24" height="24" viewBox="0 -4 25 33" fill="none" className="w-8 h-8  rounded-full bg-gray-200" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.46195 20C7.01728 20 6.63695 19.8417 6.32095 19.525C6.00495 19.2083 5.84661 18.8283 5.84595 18.385V8C5.84595 7.556 6.00428 7.176 6.32095 6.86C6.63695 6.54267 7.01695 6.384 7.46095 6.384H9.61595V4.615C9.61595 4.171 9.77395 3.791 10.0899 3.475C10.4059 3.159 10.7859 3.00067 11.2299 3H12.7699C13.2139 3 13.5939 3.15833 13.9099 3.475C14.2259 3.79167 14.3843 4.17167 14.3849 4.615V6.385H16.5389C16.9829 6.385 17.3629 6.543 17.6789 6.859C17.9956 7.17567 18.1539 7.556 18.1539 8V18.385C18.1539 18.829 17.9956 19.209 17.6789 19.525C17.3623 19.841 16.9826 19.9993 16.5399 20V20.23C16.5399 20.4367 16.4633 20.6167 16.3099 20.77C16.1566 20.9233 15.9766 21 15.7699 21C15.5633 21 15.3833 20.9233 15.2299 20.77C15.0766 20.6167 15.0003 20.4367 15.0009 20.23V20H8.99995V20.23C8.99995 20.4367 8.92328 20.6167 8.76995 20.77C8.61661 20.9233 8.43661 21 8.22995 21C8.02328 21 7.84361 20.9233 7.69095 20.77C7.53828 20.6167 7.46161 20.4367 7.46095 20.23L7.46195 20ZM10.1149 9.154C9.97295 9.154 9.85428 9.20167 9.75895 9.297C9.66361 9.39233 9.61595 9.51133 9.61595 9.654V16.731C9.61595 16.8723 9.66361 16.991 9.75895 17.087C9.85495 17.183 9.97395 17.231 10.1159 17.231C10.2579 17.231 10.3766 17.183 10.4719 17.087C10.5673 16.991 10.6153 16.8723 10.6159 16.731V9.654C10.6159 9.512 10.5676 9.39333 10.4709 9.298C10.3743 9.20267 10.2556 9.15467 10.1149 9.154ZM13.8839 9.154C13.7419 9.154 13.6233 9.202 13.5279 9.298C13.4319 9.39333 13.3839 9.512 13.3839 9.654V16.731C13.3839 16.8723 13.4323 16.991 13.5289 17.087C13.6256 17.183 13.7443 17.231 13.8849 17.231C14.0256 17.231 14.1443 17.183 14.2409 17.087C14.3376 16.991 14.3856 16.8723 14.3849 16.731V9.654C14.3849 9.512 14.3369 9.39333 14.2409 9.298C14.1449 9.202 14.0259 9.154 13.8839 9.154ZM10.6159 6.384H13.3849V4.616C13.3849 4.43667 13.3273 4.28933 13.2119 4.174C13.0966 4.05867 12.9489 4.00067 12.7689 4H11.2309C11.0509 4 10.9036 4.05767 10.7889 4.173C10.6736 4.28833 10.6159 4.436 10.6159 4.616V6.384Z" fill="#7D7D7D"/>
                        ...
                        <span className="material-icons text-xs text-gray-400">จำนวนสัมภาระ <br/>
                        <p className='text-sm text-gray-600'>ประมาณ 2-3 ใบ</p>
                        </span>
                    </div>
                    </div>
                ...
                <div className="mt-6">
                    ...
                    <ul className="list-disc list-inside text-gray-600">
                        <li className="flex items-center space-x-2">
                            ...
                            <span className='text-sm'>ระบบช่วยเตือนเมื่ออยู่มุมอับสายตา</span>
                            <span className="flex items-center space-x-2 pl-[16px]">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15 2.458C14.0291 2.1536 13.0175 1.99916 12 2C6.477 2 2 6.477 2 12C2 17.523 6.477 22 12 22C17.523 22 22 17.523 22 12C22.0008 10.9825 21.8464 9.97088 21.542 9" stroke="#0268D7" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M8.5 9.5L12 13L21 3" stroke="#0268D7" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                            <span className='text-sm'>ระบบเตือนเมื่อรถออกนอกเลน</span>
                        </span>
                        </li>
                        <li className="flex items-center space-x-2">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className='text-sm'>ระบบเซ็นเซอร์ถอยหลัง</span>
                        ...
                        <li className="flex items-center space-x-2">
                            ...
                            <span className='text-sm'>กล้องมองรอบคัน</span>
                        </li>
                    </ul>
                </div>
                <div className="mt-6">
                    ...
                    <ul className="list-disc list-inside text-gray-600">
                        <li className="flex items-center space-x-2">
                            ...
                            <span className='text-sm'>กุญแจรีโมท</span>
                            <span className=' flex items-center space-x-2 pl-[169px]'> 
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15 2.458C14.0291 2.1536 13.0175 1.99916 12 2C6.477 2 2 6.477 2 12C2 17.523 6.477 22 12 22C17.523 22 22 17.523 22 12C22.0008 10.9825 21.8464 9.97088 21.542 9" stroke="#0268D7" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M8.5 9.5L12 13L21 3" stroke="#0268D7" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                            <span className='text-sm'>Push Start/Stop</span>
                            </span>
                        </li>
                        <li className="flex items-center space-x-2">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className='text-sm'>เบาะหนัง</span>
                        </li>
                    </ul>
                </div>
                ...
                <section className="mb-8">
                    ...
                    <span className="flex flex-col">
                        ...
                        <span className='text-sm'>จันทร์-อาทิตย์ เวลาทำการ 08:00 - 20:00</span>
                    </span>
                    </p>
                    ...
                    <span className="flex flex-col">
                        ...
                        <span className='text-sm'>จันทร์-อาทิตย์ เวลาทำการ 00:00 - 07:59(ค่าบริการ ฿1,000/ทริป*)จันทร์-อาทิตย์ เวลาทำการ 20:00 - 23:59 <br/>
                            (ค่าบริการ ฿400/ทริป*)*ระบบคำนวณให้อัตโนมัติ</span>
                    </span>
                    </div>
                    <p className="mb-2 mt-5">
                        <strong>พื้นที่รับส่ง</strong><br/> <span className='text-sm'>
                ...
                <section className="mb-8">
                    ...
                    <path d="M4.375 12.25L7.4375 15.3125L16.625 5.6875" stroke="#41B95B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            ...
                            <span className='text-sm'>การันตีได้รถคันที่เลือก</span>
                        </li>
                        <li className="flex items-center space-x-2">
                    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.375 12.25L7.4375 15.3125L16.625 5.6875" stroke="#41B95B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                            <span className='text-sm'>เปลี่ยนแปลงข้อมูลตามเงื่อนไขที่กำหนด</span>
                        </li>
                    </ul>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <p>
                        <span className='list-disc ml-11 text-sm'> • ชำระค่าเช่าบางส่วนเมื่อทำการจองและชำระส่วนที่เหลือ ณ วันรับรถ</span> <br />
                        <span className='list-disc ml-11 text-sm'> • ช่องทางการชำระเงินตอนรับรถ เงินสด, โอนเงิน</span> 
                    </p>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <h2 className="text-sm  mb-4 -mt-5">ใช้ในการรับรถและการจอง</h2> <br/>
                    <h2 className="text-sm  font-bold mb-4 -mt-5">บัตรประจำตัวประชาชน หรือหนังสือเดินทาง</h2> 
                    <ul>
                ...
                <section className="mb-8">
                    ...
                    <p className='ml-11 text-sm'>• ได้รับอนุญาตมากกว่า 1 ปี</p>
                    <p className='ml-11 text-sm'>• วันหมดอายุไม่น้อยกว่า 6 เดือน</p>
                    <p className='ml-11 text-sm'>• ใบขับขี่สากลสำหรับชาวต่างชาติ (ครอบคลุมระยะเวลาการเช่ารถ)มีอายุมากกว่า 21 ปี</p>
                </section>
            </div>
            <div>
                <Footer/>

        ...
        <div className="relative">
            ...
            <div className="container mx-auto px-4 mt-4 flex gap-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-md w-1/2">
                    ...
                    <div> 
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="50" className="ml-20 mt-10">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="50" className="ml-20 mt-10">
                        ...
                        <p className="text-sm text-gray-600 ml-56">
                    ...
                    <div className="text-sm text-gray-600">
                        <div className="flex items-center gap-2">
                            <img
                                ...
                                alt="RN Rent A Car"
                                className="w-28 h-22 rounded-md mt-12 ml-10"
                            />
                            <span className="ml-16 mt-10">
            ...
            <div className="bg-white border p-4 rounded-md shadow-md mt-4">

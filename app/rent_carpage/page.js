...
export default function Home() {
    ...
    return (
        <div className="relative">
            ...
            <div className="bg-white border p-4 rounded-md shadow-md mt-[-240px] w-[543px] ml-[730px]">
                <p className="text-center text-black mb-4">
                    กรุณาตรวจสอบข้อมูลการเช่าให้ครบถ้วนก่อนการกดยืนยัน
                </p>
                <button
                    type="submit"
                    className="bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600 w-[500px] block mx-auto">
                    ยืนยันข้อมูล
                </button>
            </div>
            <div>

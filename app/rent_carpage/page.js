...
export default function Home() {
    ...
    return (
        <div className="relative">
            ...
            <div className="container mx-auto px-4 mt-4 flex gap-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-md w-1/2">
                    ...
                    <div> 
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="50" className="ml-[85.5px]">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="50" className="ml-[85.5px]">
                          ...
                          {/* เส้นประแนวตั้ง */}
                          <div className="border-l border-dashed border-yellow-500 h-12 ml-[95px] mt-10"></div>
                         ...
                         {/* เส้นประแนวตั้ง */}
                         <div className="border-l border-dashed border-yellow-500 h-12 ml-[95px] mt-4"></div>
            ...
            <div className="bg-white border p-4 rounded-md shadow-md -mt-96 w-[620px] ml-[730px]">
       ...
       {/* Bottom Navbar */}
       <div className="bg-gray-800 text-white py-2 w-full min-h-[250] flex items-center justify-center mt-72">
